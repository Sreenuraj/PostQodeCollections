...
When generating test code for interactions where standard locators don't work and coordinate-based interaction is needed, follow this strategy.

## When This Applies

- An element cannot be located by any standard locator (text, role, CSS, testid)
- The element is inside a canvas, SVG, or chart that lacks DOM structure
- Drag-and-drop operations between elements
- Clicking on visual elements without unique selectors (map pins, chart points, etc.)
